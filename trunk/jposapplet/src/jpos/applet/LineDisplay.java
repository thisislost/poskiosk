...
public class LineDisplay extends jpos.LineDisplay {

    public void readCharacterAtCursor(JSObject aChar) throws jpos.JposException {
        int[] ints = new int[1];
        super.readCharacterAtCursor(ints);
        aChar.setSlot(0, ints[0]);
    }
