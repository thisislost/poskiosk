...
public class PINPad extends jpos.PINPad {
    ...
    public void computeMAC(String inMsg, JSObject outMsg) throws jpos.JposException {
        String[] strings = new String[1];
        super.computeMAC(inMsg, strings);
        outMsg.setSlot(0, strings[0]);
    }
